...
export function buildLoopPrompt(
  ...
  parts.push(
    ...
    '',
    '### commit_to_main - Push workspace changes to GitHub',
    '⚠️ **MANDATORY after creating/modifying files in workspace!**',
    '```json',
    '{ "type": "commit_to_main", "data": { "message": "Short description of changes" } }',
    '```',
    '',
    '🚨 **IF YOU WROTE/EDITED ANY FILES, YOU MUST INCLUDE commit_to_main IN YOUR ACTIONS!**',
    'Files not committed will be lost. Always commit your work.',
    '',
